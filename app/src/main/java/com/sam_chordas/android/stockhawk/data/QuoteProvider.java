 ...
 */
@ContentProvider(authority = QuoteProvider.AUTHORITY, database = QuoteDatabase1.class)
public class QuoteProvider {
  ...
  private static Uri buildUri(String... paths){
    ...
    @TableEndpoint(table = QuoteDatabase1.HISTORY)
  ...
  @TableEndpoint(table = QuoteDatabase1.QUOTES)
